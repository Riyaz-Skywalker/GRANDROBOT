...
TECHNO_IMG = "https://telegra.ph/file/ed83eb9255c31c0074e81.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/cherry_boi_kakyoin")],
                                                                                   [InlineKeyboardButton(text="ADD YUUKI ASUNA TO YOUR GROUP",
        ...
        update.effective_message.reply_text("Hewwo! :3")
